...
void Window_::Window::InitOpenGL(void)
{
	...
	//g_hRC = wglCreateContextAttribsARB(g_hDC, 0, 0);
...
void Window_::Window::InitWindow(HINSTANCE exe_start_adress)
{
	...
	wndclass.hbrBackground = CreateSolidBrush(RGB(0x0f, 0xaf, 0xaf));
	wndclass.hCursor = LoadCursor(NULL, IDC_ARROW);
	wndclass.hIcon = LoadIcon(NULL, IDI_WINLOGO);
	wndclass.hIconSm = NULL;
	wndclass.hInstance = exe_start_adress;
	wndclass.lpfnWndProc = WndProc;
	wndclass.lpszClassName = L"Battleship.";
...
void Window_::Window::UpdateInput(void)
{

}

void Window_::Window::Draw(void)
{
	if (mEngine->CloseGame())
